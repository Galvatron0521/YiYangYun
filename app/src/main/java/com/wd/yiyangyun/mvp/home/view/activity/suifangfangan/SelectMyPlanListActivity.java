...
public class SelectMyPlanListActivity extends BaseActivity{
...
//        my_plan_list_cancel_springview.setHeader(new DefaultHeader(mContext));
        my_plan_list_cancel_springview.setFooter(new DefaultFooter(this));


        followprojectID = getIntent().getStringExtra("followprojectID");
        taskNum = getIntent().getStringExtra("taskNum");
        isBaocun = getIntent().getBooleanExtra("isBaoCun",false);
    ...
    protected void initData() {
        super.initData();
            ...
            myPlanCrfListAdapter = new MyPlanCrfListAdapter(this, mDatas);
...
//                requestListDatas();
            ...
            my_plan_list_add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("tttttttttt", "selectmyplan传递的值1或2   "+sb.toString());
        ...
        DoctorNetService.requestFollowCRFList(Constants.SELECT_FOLLOW_CRF_LIST_NEW, map, new
                NetWorkRequestInterface() {
                    ...
                    public void onNext(Object info) {
                        ...
                        Log.e("tttttt", "onNext  : "+myPlanCRFListBean.crflist.size());
